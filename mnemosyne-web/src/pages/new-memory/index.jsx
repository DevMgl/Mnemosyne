...
const NewMemory = () => {
    ...
    const onSetImage = (event) => {
        ...
        setImages(files); //lista de imagens
        ...
        for(let contador = 0; contador < files.length; contador++){
          ...
          imageURL.push(thumbnail); //Acrescenta na lista
    ...
    <div className="form-container">
        ...
        <label htmlFor="file-input" className="file">
            ...
            <div className="images-container">
              {imageURL.map((imageURL_, index) => (
               
               <div key={index} className= "image" style={{backgroundImage: `url(${imageURL_})`}}> </div>
